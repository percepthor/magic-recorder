...
extern char *c_string_concat (const char *s1, const char *s2, size_t *des_size);
...
extern size_t c_string_concat_safe (const char *s1, const char *s2, const char *des, size_t des_size);
